...
func init() {
	...
	gameparticipantFields := schema.GameParticipant{}.Fields()
	_ = gameparticipantFields
	// gameparticipantDescCreatedAt is the schema descriptor for created_at field.
	gameparticipantDescCreatedAt := gameparticipantFields[0].Descriptor()
	// gameparticipant.DefaultCreatedAt holds the default value on creation for the created_at field.
	gameparticipant.DefaultCreatedAt = gameparticipantDescCreatedAt.Default.(func() time.Time)
